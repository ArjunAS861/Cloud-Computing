...
//import java.text.DecimalFormat;
		...
		public class MinMin{
			...
			private static void printCloudletList(List<Cloudlet> list) {
				...
				Log.printLine("Cloudlet ID" + indent+ indent + "STATUS" + indent + indent+						"Data center ID" + indent + indent+ "VM ID" + indent + indent + "    "+"Time" + indent + indent+ indent+ indent +"Start Time" + indent + indent+ indent + indent+ "Finish Time");
			    String indent2="      ";
		...
		/* Min-Min algorithm */
			public static void bindCloudletToVmsMinMin() 
			{
				...
				do {
					...
					// find smallest in each row; and find the smallest of all;
			...
			/*return the only one value from this map =>minimum of expected completion */
			 ...
			 {
				 String indent="           ";
				 System.out.println("The current required completion time matirx is as below,with size of "+ table.size()+" by "+table.get(0).size());
